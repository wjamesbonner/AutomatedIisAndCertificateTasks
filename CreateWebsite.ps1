...
if (!(Test-Path IIS:\Sites\$siteName -pathType container))
{
    ...
    New-WebBinding -Name $siteName -IPAddress "*" -Port 443 -HostHeader $domain -Protocol "https"
}
...
if (!(Get-ACMEVault))
{
    ...
    New-ACMERegistration -Contacts mailto:account@example.com -AcceptTos
}
...
$binding = Get-WebBinding -Protocol "https" -Name $siteName
